                            ...
                            <div class='col-md-12'>
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Correction or Immediate Action:</th>
                                            <th>Corrective Action Plan:</th>
                                        </tr>
                                        <tr>
                                            <td><small><i>(Immediate response to temporarily address the cause of observation within
                                                24 hours turn-around time)</i></small>
                                                <br>
                                                <textarea class='form-control' name='immediate_action'  rows="6" cols="100" required></textarea> <br>
                                                <div class='form-group'>
                                                 ...
                                                 <div class='form-group text-left'>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name='date_completed' class='form-control form-control-sm' type='date' required >
                                                    </div>
                                                </div>
                                            </td>
                                            <td><small><i>(Controls that, if will be in place, may prevent the occurrence of the
                                                same observation)</i></small>
                                                <br>
                                                <textarea class='form-control' name='action_plan'  rows="6" cols="100" required></textarea> <br>
                                                <div class='form-group text-left'>
                                                    <label class='col-sm-6 control-label text-left'>Other Party(ies) Involved :</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class='form-group text-left'>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name='date_complete' class='form-control form-control-sm' type='date' required >
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
