                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name='other_parties_immediate_action[{{$action_plan->id}}][]' readonly data-placeholder="Other Party(ies) Involved (optional)" class='form-control form-control-sm cat' multiple >
                                                            <option value=''></option>
                                                 ...
                                                 <div class='form-group text-left'>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name='date_completed[{{$action_plan->id}}]' readonly class='form-control form-control-sm' value='{{$action_plan->date_completed}}'  type='date' required >
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class='form-group text-left'>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name='date_complete[{{$action_plan->id}}]' readonly class='form-control form-control-sm' value='{{$action_plan->target_date}}'  type='date' required >
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
