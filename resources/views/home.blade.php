                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td> 
                                ...
                                <a 
                                    @if(auth()->user()->role != "Auditee") 
                                        href="{{ url('action-plans?department=' . implode(',', $dep_grou) . '&status_report=Closed&generated_date=' . $generate_date) }}" 
                                        target="_blank"
                                    @endif>
                                    {{$close_count}}
                                </a>
                           ...
                           <td>
                                ...
                                <a 
                                    @if(auth()->user()->role != "Auditee") 
                                        href="{{ url('action-plans?department=' . implode(',', $dep_grou) . '&status_report=Delayed&generated_date=' . $generate_date) }}" 
                                        target="_blank"
                                    @endif>
                                    {{$delayed_count}}
                                </a>
                           ...
                           <td>
                            ...
                            {{-- <a @if(auth()->user()->role != "Auditee") data-toggle="modal" target='_blank' href="#view_open_group{{$key}}" @endif>{{$open}}</a> --}}
                                <a 
                                    @if(auth()->user()->role != "Auditee") 
                                        href="{{ url('action-plans?department=' . implode(',', $dep_grou) . '&status_report=Open&generated_date=' . $generate_date) }}" 
                                        target="_blank"
                                    @endif>
                                    {{$open}}
                                </a>
