<div class="modal fade" id="view_group{{$key}}" tabindex="-1" aria-labelledby="addIncome" aria-hidden="true">
               ...
               <div class="modal-body">  
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        @foreach(($depar->action_plans)->where('action_plan','!=',"N/A")->where('status','Closed') as $action_plan)
                            <tr>
