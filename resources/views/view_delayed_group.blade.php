<div class="modal fade" id="view_delayed_group{{$key}}" tabindex="-1" aria-labelledby="addIncome" aria-hidden="true">
        ...
        <div class="modal-content">
               ...
               <div class="modal-body">  
                <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach($departments->whereIn('id',$dep_grou) as $depar)
                        @foreach(($depar->action_plans)->where('action_plan','!=',"N/A")->where('status','Verified')->where('target_date','<',date('Y-m-d')) as $action_plan)
                            <tr>
