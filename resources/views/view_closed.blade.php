<div class="modal fade" id="view{{$department->id}}" tabindex="-1" aria-labelledby="addIncome" aria-hidden="true">
            ...
            <div class="modal-content">
                   ...
                   <div class="modal-body">  
                    <div class="table-responsive">
                        ...
                        <tbody>
                            @foreach(($department->action_plans)->where('action_plan','!=',"N/A")->where('status','Closed') as $action_plan)
                                <tr>
