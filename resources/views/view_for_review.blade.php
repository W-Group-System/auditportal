                        ...
                        <div class="row">
                            ...
                            <div class='col-md-12'>
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style='width:50%'><textarea class='form-control'  rows="10" cols="100" name='explanation' readonly required>{{$observation->explanation->explanation}}</textarea></td>
                                        ...
                                        <tr>
                                            <td>
                                                <textarea class='form-control' name='immediate_action[{{$action_plan->id}}]' readonly  rows="6" cols="100" required placeholder="Correction or Immediate Action">{{$action_plan->action_plan}}</textarea> </td>
                                                <td>
                                                <div class='form-group'>
                                                 ...
                                                 <div class='form-group text-left'>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name='date_completed[{{$action_plan->id}}]' class='form-control form-control-sm' value='{{$action_plan->date_completed}}' readonly max='{{date('Y-m-d',strtotime("+7 day", strtotime($action_plan->created_at)))}}' type='date' required >
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class='form-control' name='action_plan[{{$action_plan->id}}]' readonly  rows="6" cols="100" required placeholder='Corrective Action Plan'>{{$action_plan->action_plan}}</textarea> </td>
                                                <td>
                                                <div class='form-group text-left'>
                                                    <label class='col-sm-6 control-label text-left'>Other Party(ies) Involved :</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class='form-group text-left'>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name='date_complete[{{$action_plan->id}}]' readonly class='form-control form-control-sm' value='{{$action_plan->target_date}}' max='{{date('Y-m-d',strtotime("+1 month", strtotime(date($action_plan->created_at))))}}' type='date' required >
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
