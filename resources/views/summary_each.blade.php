...
<body> 
    ...
    <header>
        <table style='width:100%;' border="1" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class='text-center'>
                    <span  style='font-size:18;text-align: center;'><b>STATUS REPORT AS OF {{date("F Y")}}</b>
                    </span>
                </td>
            </tr>
        </table>
    ...
    <table border='1' style='width:100%;font-size:8;' id='audit'  cellspacing="0" cellpadding="0" >
        <tr>
            <th class="text-center" >Agreed Action Plan No.</th>
            <th class="text-center" >Agreed Action Plan</th>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                @php
                    $remarks = ($action_plan->histories)->where('action','Change Target Date')->first()->remarks;
                    $replace_string = str_replace("Change Target Date from ","",$remarks);
                    $rem = substr($replace_string, 0, 10);
                @endphp
                {{$rem}}
                @else
