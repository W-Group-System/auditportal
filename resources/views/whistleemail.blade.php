        ...
        <td class="container">
          <div class="content">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  <p>We would like to inform you that a new whistleblower report has been submitted. The report is now recorded.
                    <br>
                    <br>
                    Details :
                    <br>
                    ...
                    <table role="presentation" border="1" cellpadding="0" cellspacing="0" class="btn btn-primary">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td align="left">
                                {{$data['data']->department_of_respondent}}
                            </td>
                          </tr>
                          <tr>
                            <td width="30%">
                            ...
                            <td align="left">
                                {{date('M d,Y',strtotime($data['data']->date_of_incident))}}
                            </td>
                          </tr>
                          <tr>
                            <td width="30%">
                          ...
                          <tr>
                            ...
                            <td align="left">
                                {{$data['data']->name_of_whistleblower}}
                            </td>
                          </tr>
                        </tbody>
                      </table>
